<details>
  ...
  <ul>
    ...
    <li>Analyzer: GFIs from Frenzy not included</li>
    ...
    <li>
      Analyzer: Push/Follow Up/Standfirm affects on player position value aren't
      accounted for
    </li>
    ...
    <li>
      Analyzer: Correctly account for current player state when rolling armor
      rolls (for instance, no extra volue for stunning a stunned player again
      with a foul or a pileon)
    </li>
    <li>
