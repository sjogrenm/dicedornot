...
<body>
  ...
  <div class="container-flex">
    <div class="jumbotron">
      <About/>
      <ReplayLoader
        on:replayLoaded={(e) => { loading = false; replay = e.detail; console.log(e); }}
        on:replayLoading={() => { replay = null; error = false; loading = true } }
        on:replayError={() => {loading=false; error = true; replay = null;}}
      />
    </div>
