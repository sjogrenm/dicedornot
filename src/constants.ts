...
export interface StarTV {
  tv: number,
  star: true,
}

export const PLAYER_TVS: Map<PLAYER_TYPE, PlayerTV | StarTV> = new Map([
  [PLAYER_TYPE.AmazonBlitzer, { tv: 90, normals: 'GS', doubles: 'AP', free: [SKILL.Block, SKILL.Dodge] }],
  [PLAYER_TYPE.AmazonCatcher, { tv: 70, normals: 'GA', doubles: 'PS', free: [SKILL.Dodge, SKILL.Catch] }],
  [PLAYER_TYPE.AmazonLinewoman, { tv: 50, normals: 'G', doubles: 'APS', free: [SKILL.Dodge] }],
  [PLAYER_TYPE.AmazonThrower, { tv: 70, normals: 'GP', doubles: 'AS', free: [SKILL.Dodge, SKILL.Pass] }],
  [PLAYER_TYPE.ChaosBeastman, { tv: 60, normals: 'GSM', doubles: 'AP', free: [SKILL.Horns] }],
  [PLAYER_TYPE.ChaosMinotaur, { tv: 150, normals: 'SM', doubles: 'GAP', free: [SKILL.ThickSkull, SKILL.MightyBlow, SKILL.Horns, SKILL.Frenzy, SKILL.Loner, SKILL.WildAnimal] }],
  [PLAYER_TYPE.ChaosWarrior, { tv: 100, normals: 'GSM', doubles: 'AP', free: [] }],
  [PLAYER_TYPE.ChaosdwarfBlocker, { tv: 70, normals: 'GS', doubles: 'APM', free: [SKILL.Block, SKILL.Tackle, SKILL.ThickSkull] }],
  [PLAYER_TYPE.ChaosdwarfBullcentaur, { tv: 130, normals: 'GS', doubles: 'AP', free: [SKILL.Sprint, SKILL.SureFeet, SKILL.ThickSkull] }],
  [PLAYER_TYPE.ChaosdwarfHobgoblin, { tv: 40, normals: 'G', doubles: 'APS', free: [] }],
  [PLAYER_TYPE.ChaosdwarfMinotaur, { tv: 150, normals: 'S', doubles: 'GAPM', free: [SKILL.Loner, SKILL.Frenzy, SKILL.Horns, SKILL.MightyBlow, SKILL.ThickSkull, SKILL.WildAnimal] }],
  [PLAYER_TYPE.DarkelfLineman, { tv: 70, normals: 'GA', doubles: 'PS', free: [] }],
  [PLAYER_TYPE.DarkelfRunner, { tv: 80, normals: 'GAP', doubles: 'S', free: [SKILL.DumpOff] }],
  [PLAYER_TYPE.DarkelfAssasin, { tv: 90, normals: 'GA', doubles: 'PS', free: [SKILL.Shadowing, SKILL.Stab] }],
  [PLAYER_TYPE.DarkelfBlitzer, { tv: 100, normals: 'GA', doubles: 'PS', free: [SKILL.Block] }],
  [PLAYER_TYPE.DarkelfWitchelf, { tv: 110, normals: 'GA', doubles: 'PS', free: [SKILL.Frenzy, SKILL.Dodge, SKILL.JumpUp] }],
  [PLAYER_TYPE.DwarfLongbeard, { tv: 70, normals: 'GS', doubles: 'AP', free: [SKILL.Block, SKILL.ThickSkull, SKILL.Tackle] }],
  [PLAYER_TYPE.DwarfBlitzer, { tv: 80, normals: 'PS', doubles: 'AP', free: [SKILL.Block, SKILL.ThickSkull] }],
  [PLAYER_TYPE.DwarfRunner, { tv: 80, normals: 'GP', doubles: 'AS', free: [SKILL.SureHands, SKILL.ThickSkull] }],
  [PLAYER_TYPE.DwarfTrollslayer, { tv: 90, normals: 'GS', doubles: 'AP', free: [SKILL.Block, SKILL.ThickSkull, SKILL.Dauntless, SKILL.Frenzy] }],
  [PLAYER_TYPE.DwarfDeathroller, { tv: 160, normals: 'S', doubles: 'GAP', free: [SKILL.BreakTackle, SKILL.DirtyPlayer, SKILL.Juggernaut, SKILL.MightyBlow, SKILL.NoHands, SKILL.SecretWeapon, SKILL.StandFirm, SKILL.Loner] }],
  [PLAYER_TYPE.GoblinGoblin, { tv: 40, normals: 'A', doubles: 'GPS', free: [SKILL.RightStuff, SKILL.Dodge, SKILL.Stunty] }],
  [PLAYER_TYPE.GoblinLooney, { tv: 40, normals: 'A', doubles: 'GPS', free: [SKILL.SecretWeapon, SKILL.Stunty, SKILL.Chainsaw] }],
  [PLAYER_TYPE.GoblinTroll, { tv: 110, normals: 'S', doubles: 'GAP', free: [SKILL.AlwaysHungry, SKILL.Loner, SKILL.MightyBlow, SKILL.ReallyStupid, SKILL.Regeneration, SKILL.ThrowTeamMate] }],
  [PLAYER_TYPE.GoblinPogo, { tv: 70, normals: 'A', doubles: 'GPS', free: [SKILL.Dodge, SKILL.Leap, SKILL.VeryLongLegs, SKILL.Stunty] }],
  [PLAYER_TYPE.GoblinFanatic, { tv: 70, normals: 'S', doubles: 'GAP', free: [SKILL.SecretWeapon, SKILL.BallAndChain, SKILL.NoHands, SKILL.Stunty] }],
  [PLAYER_TYPE.GoblinBomber, { tv: 40, normals: 'A', doubles: 'GPS', free: [SKILL.Bombardier, SKILL.Dodge, SKILL.Stunty, SKILL.SecretWeapon] }],
  [PLAYER_TYPE.HalflingHalfling, { tv: 30, normals: 'A', doubles: 'GPS', free: [SKILL.Dodge, SKILL.RightStuff, SKILL.Stunty] }],
  [PLAYER_TYPE.HalflingTreeman, { tv: 120, normals: 'S', doubles: 'GAP', free: [SKILL.MightyBlow, SKILL.StandFirm, SKILL.StrongArm, SKILL.ThickSkull, SKILL.ThrowTeamMate, SKILL.TakeRoot] }],
  [PLAYER_TYPE.HighelfLineman, { tv: 70, normals: 'GA', doubles: 'PS', free: [] }],
  [PLAYER_TYPE.HighelfThrower, { tv: 90, normals: 'GAP', doubles: 'S', free: [SKILL.Pass, SKILL.SafeThrow] }],
  [PLAYER_TYPE.HighelfCatch, { tv: 90, normals: 'GA', doubles: 'PS', free: [SKILL.Catch] }],
  [PLAYER_TYPE.HighelfBlitzer, { tv: 100, normals: 'GA', doubles: 'PS', free: [SKILL.Block] }],
  [PLAYER_TYPE.HumanLineman, { tv: 50, normals: 'G', doubles: 'APS', free: [] }],
  [PLAYER_TYPE.HumanCatcher, { tv: 70, normals: 'GA', doubles: 'PS', free: [SKILL.Dodge, SKILL.Catch] }],
  [PLAYER_TYPE.HumanThrower, { tv: 70, normals: 'GP', doubles: 'AS', free: [SKILL.Pass, SKILL.SureHands] }],
  [PLAYER_TYPE.HumanBlitzer, { tv: 90, normals: 'GS', doubles: 'AP', free: [SKILL.Block] }],
  [PLAYER_TYPE.HumanOgre, { tv: 130, normals: 'S', doubles: 'GAP', free: [SKILL.BoneHead, SKILL.MightyBlow, SKILL.ThickSkull, SKILL.ThrowTeamMate, SKILL.Loner] }],
  [PLAYER_TYPE.KhemriLineman, { tv: 40, normals: 'G', doubles: 'APS', free: [SKILL.Regeneration, SKILL.ThickSkull] }],
  [PLAYER_TYPE.KhemriThrower, { tv: 70, normals: 'GP', doubles: 'AS', free: [SKILL.Pass, SKILL.Regeneration, SKILL.SureHands] }],
  [PLAYER_TYPE.KhemriBlitzer, { tv: 90, normals: 'GS', doubles: 'AP', free: [SKILL.Block, SKILL.Regeneration] }],
  [PLAYER_TYPE.KhemriMummy, { tv: 100, normals: 'S', doubles: 'GAP', free: [SKILL.Decay, SKILL.Regeneration] }],
  [PLAYER_TYPE.LizardmanSkink, { tv: 60, normals: 'A', doubles: 'GPS', free: [SKILL.Stunty, SKILL.MightyBlow] }],
  [PLAYER_TYPE.LizardmanSaurus, { tv: 80, normals: 'GS', doubles: 'AP', free: [] }],
  [PLAYER_TYPE.LizardmanKroxigor, { tv: 140, normals: 'S', doubles: 'GAP', free: [SKILL.Loner, SKILL.MightyBlow, SKILL.BoneHead, SKILL.PrehensileTail, SKILL.ThickSkull] }],
  [PLAYER_TYPE.NecromanticZombie, { tv: 40, normals: 'G', doubles: 'APS', free: [SKILL.Regeneration] }],
  [PLAYER_TYPE.NecromanticGhoul, { tv: 70, normals: 'GA', doubles: 'PS', free: [SKILL.Dodge] }],
  [PLAYER_TYPE.NecromanticWight, { tv: 90, normals: 'GS', doubles: 'AP', free: [SKILL.Block, SKILL.Regeneration] }],
  [PLAYER_TYPE.NecromanticGolem, { tv: 110, normals: 'GS', doubles: 'AP', free: [SKILL.Regeneration, SKILL.StandFirm, SKILL.ThickSkull] }],
  [PLAYER_TYPE.NecromanticWerewolf, { tv: 120, normals: 'GA', doubles: 'PS', free: [SKILL.Regeneration, SKILL.Claw, SKILL.Frenzy] }],
  [PLAYER_TYPE.NorseLineman, { tv: 50, normals: 'G', doubles: 'APS', free: [SKILL.Block] }],
  [PLAYER_TYPE.NorseThrower, { tv: 70, normals: 'GP', doubles: 'AS', free: [SKILL.Block, SKILL.Pass] }],
  [PLAYER_TYPE.NorseRunner, { tv: 90, normals: 'GA', doubles: 'PS', free: [SKILL.Block, SKILL.Dauntless] }],
  [PLAYER_TYPE.NorseBerserker, { tv: 90, normals: 'GS', doubles: 'AP', free: [SKILL.Block, SKILL.Frenzy, SKILL.JumpUp] }],
  [PLAYER_TYPE.NorseUlfwerener, { tv: 110, normals: 'GS', doubles: 'AP', free: [SKILL.Frenzy] }],
  [PLAYER_TYPE.NorseYhetee, { tv: 140, normals: 'S', doubles: 'GAP', free: [SKILL.Loner, SKILL.Claw, SKILL.DisturbingPresence, SKILL.Frenzy, SKILL.WildAnimal] }],
  [PLAYER_TYPE.NurgleRotter, { tv: 40, normals: 'GM', doubles: 'APS', free: [SKILL.Decay, SKILL.NurglesRot] }],
  [PLAYER_TYPE.NurglePestigor, { tv: 80, normals: 'GSM', doubles: 'AP', free: [SKILL.Horns, SKILL.NurglesRot, SKILL.Regeneration] }],
  [PLAYER_TYPE.NurgleWarrior, { tv: 110, normals: 'GSM', doubles: 'AP', free: [SKILL.DisturbingPresence, SKILL.FoulAppearance, SKILL.NurglesRot, SKILL.Regeneration] }],
  [PLAYER_TYPE.NurgleBeast, { tv: 140, normals: 'S', doubles: 'GAPM', free: [SKILL.Loner, SKILL.DisturbingPresence, SKILL.FoulAppearance, SKILL.MightyBlow, SKILL.NurglesRot, SKILL.ReallyStupid, SKILL.Regeneration, SKILL.Tentacles] }],
  [PLAYER_TYPE.OgreSnotling, { tv: 20, normals: 'A', doubles: 'GPS', free: [SKILL.Dodge, SKILL.RightStuff, SKILL.SideStep, SKILL.Stunty, SKILL.Titchy] }],
  [PLAYER_TYPE.OgreOgre, { tv: 140, normals: 'S', doubles: 'GAP', free: [SKILL.BoneHead, SKILL.MightyBlow, SKILL.ThickSkull, SKILL.ThrowTeamMate] }],
  [PLAYER_TYPE.OrcLineman, { tv: 50, normals: 'G', doubles: 'APS', free: [] }],
  [PLAYER_TYPE.OrcGoblin, { tv: 40, normals: 'A', doubles: 'GPS', free: [SKILL.RightStuff, SKILL.Dodge, SKILL.Stunty] }],
  [PLAYER_TYPE.OrcThrower, { tv: 70, normals: 'GP', doubles: 'AS', free: [SKILL.Pass, SKILL.SureHands] }],
  [PLAYER_TYPE.OrcBlocker, { tv: 80, normals: 'GS', doubles: 'AP', free: [] }],
  [PLAYER_TYPE.OrcBlitzer, { tv: 80, normals: 'GS', doubles: 'AP', free: [SKILL.Block] }],
  [PLAYER_TYPE.OrcTroll, { tv: 110, normals: 'S', doubles: 'GAP', free: [SKILL.Loner, SKILL.AlwaysHungry, SKILL.MightyBlow, SKILL.ReallyStupid, SKILL.Regeneration, SKILL.ThrowTeamMate] }],
  [PLAYER_TYPE.ProelfLineman, { tv: 60, normals: 'GA', doubles: 'PS', free: [] }],
  [PLAYER_TYPE.ProelfThrower, { tv: 70, normals: 'GAP', doubles: 'S', free: [SKILL.Pass] }],
  [PLAYER_TYPE.ProelfCatcher, { tv: 100, normals: 'GA', doubles: 'PS', free: [SKILL.Catch, SKILL.NervesOfSteel] }],
  [PLAYER_TYPE.ProelfBlitzer, { tv: 110, normals: 'GA', doubles: 'PS', free: [SKILL.Block, SKILL.SideStep] }],
  [PLAYER_TYPE.SkavenLineman, { tv: 50, normals: 'G', doubles: 'APSM', free: [] }],
  [PLAYER_TYPE.SkavenThrower, { tv: 70, normals: 'GP', doubles: 'ASM', free: [SKILL.Pass, SKILL.SureHands] }],
  [PLAYER_TYPE.SkavenRunner, { tv: 80, normals: 'GA', doubles: 'PSM', free: [SKILL.Dodge] }],
  [PLAYER_TYPE.SkavenBlitzer, { tv: 90, normals: 'GS', doubles: 'APM', free: [SKILL.Block] }],
  [PLAYER_TYPE.SkavenRatogre, { tv: 150, normals: 'S', doubles: 'GAPM', free: [SKILL.Frenzy, SKILL.MightyBlow, SKILL.Loner, SKILL.PrehensileTail, SKILL.WildAnimal] }],
  [PLAYER_TYPE.UndeadSkeleton, { tv: 40, normals: 'G', doubles: 'ASP', free: [SKILL.Regeneration, SKILL.ThickSkull] }],
  [PLAYER_TYPE.UndeadZombie, { tv: 40, normals: 'G', doubles: 'APS', free: [SKILL.Regeneration] }],
  [PLAYER_TYPE.UndeadGhoul, { tv: 70, normals: 'GA', doubles: 'SP', free: [SKILL.Dodge] }],
  [PLAYER_TYPE.UndeadWight, { tv: 90, normals: 'GS', doubles: 'AP', free: [SKILL.Regeneration, SKILL.Block] }],
  [PLAYER_TYPE.UndeadMummy, { tv: 120, normals: 'S', doubles: 'GAP', free: [SKILL.Regeneration, SKILL.MightyBlow] }],
  [PLAYER_TYPE.UnderworldGoblin, { tv: 40, normals: 'AM', doubles: 'GPS', free: [SKILL.RightStuff, SKILL.Dodge, SKILL.Stunty] }],
  [PLAYER_TYPE.UnderworldLineman, { tv: 50, normals: 'GM', doubles: 'APS', free: [SKILL.Animosity] }],
  [PLAYER_TYPE.UnderworldThrower, { tv: 70, normals: 'GPM', doubles: 'AS', free: [SKILL.Animosity, SKILL.Pass, SKILL.SureHands] }],
  [PLAYER_TYPE.UnderworldBlitzer, { tv: 90, normals: 'GSM', doubles: 'AP', free: [SKILL.Animosity, SKILL.Block] }],
  [PLAYER_TYPE.UnderworldTroll, { tv: 110, normals: 'SM', doubles: 'GAP', free: [SKILL.Loner, SKILL.AlwaysHungry, SKILL.MightyBlow, SKILL.ReallyStupid, SKILL.Regeneration, SKILL.ThrowTeamMate] }],
  [PLAYER_TYPE.VampireThrall, { tv: 40, normals: 'G', doubles: 'ASP', free: [] }],
  [PLAYER_TYPE.VampireVampire, { tv: 110, normals: 'GAS', doubles: 'P', free: [SKILL.BloodLust, SKILL.HypnoticGaze, SKILL.Regeneration] }],
  [PLAYER_TYPE.WoodelfLineman, { tv: 70, normals: 'GA', doubles: 'PS', free: [] }],
  [PLAYER_TYPE.WoodelfCatcher, { tv: 90, normals: 'GA', doubles: 'PS', free: [SKILL.Catch, SKILL.Dodge, SKILL.Sprint] }],
  [PLAYER_TYPE.WoodelfThrower, { tv: 90, normals: 'GAP', doubles: 'S', free: [SKILL.Pass] }],
  [PLAYER_TYPE.WoodelfWardancer, { tv: 120, normals: 'GA', doubles: 'PS', free: [SKILL.Block, SKILL.Dodge, SKILL.Leap] }],
  [PLAYER_TYPE.WoodelfTree, { tv: 120, normals: 'S', doubles: 'GAP', free: [SKILL.MightyBlow, SKILL.Loner, SKILL.StandFirm, SKILL.StrongArm, SKILL.ThickSkull, SKILL.ThrowTeamMate, SKILL.TakeRoot] }],
  [PLAYER_TYPE.KislevLineman, { tv: 60, normals: 'G', doubles: 'APS', free: [SKILL.Leap, SKILL.VeryLongLegs] }],
  [PLAYER_TYPE.KislevCatcher, { tv: 80, normals: 'GA', doubles: 'PS', free: [SKILL.Leap, SKILL.VeryLongLegs, SKILL.DivingCatch] }],
  [PLAYER_TYPE.KislevBlitzer, { tv: 110, normals: 'GAS', doubles: 'P', free: [SKILL.Leap, SKILL.VeryLongLegs, SKILL.JumpUp, SKILL.DivingTackle] }],
  [PLAYER_TYPE.KislevBear, { tv: 140, normals: 'S', doubles: 'GAP', free: [SKILL.PrehensileTail, SKILL.MightyBlow, SKILL.ThickSkull, SKILL.BoneHead, SKILL.Loner] }],
  [PLAYER_TYPE.BretonniaPeasant, { tv: 40, normals: 'G', doubles: 'APS', free: [SKILL.Fend] }],
  [PLAYER_TYPE.BretonniaBlocker, { tv: 70, normals: 'GS', doubles: 'AP', free: [SKILL.Wrestle] }],
  [PLAYER_TYPE.BretonniaKnight, { tv: 110, normals: 'GAP', doubles: 'S', free: [SKILL.Block, SKILL.Catch, SKILL.Dauntless] }],
